...
function fourGliders(i, j) {
    ...
    for (let i = 0; i < rows; i++) {
        for (let j = 0; j < cols; j++) {
            ...
            if ((i == 0 && j == 19) || (i == 1 && j == 18) || (i == 1 && j == 17) || (i == 2 && j == 19) || (i == 2 && j == 18) || (i == 19 && j == 19) || (i == 18 && j == 18) || (i == 18 && j == 17) || (i == 17 && j == 19) || (i == 17 && j == 18) || (i == 19 && j == 0) || (i == 19 && j == 2) || (i == 18 && j == 1) || (i == 18 && j == 2) || (i == 17 && j == 1) || (i == 0 && j == 0)|| (i == 1 && j == 1) || (i == 1 && j == 2) || (i == 2 && j == 0) || (i == 2 && j == 1) ){
